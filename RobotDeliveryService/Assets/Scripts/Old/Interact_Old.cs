...
public class Interact_Old : MonoBehaviour
{
    ...
    {
        questUI.SetActive(false);
        currentQuestNameUI.GetComponent<Text>().text = "   Quest: " + questNameUI.GetComponent<Text>().text;
        currentQuestNameUI.SetActive(true);
                ...
                {   // Assume object is either building or NPC
                    ...
                    else if (ID == 1)
                    {
					  ...
					  questNameUI.GetComponent<Text>().text = "Getting ahead in life";
						...
						currentQuestNameUI.GetComponent<Text>().text = "";
						questNameUI.SetActive(true);
						questInfoUI.SetActive(true);
						isTalking = true;
